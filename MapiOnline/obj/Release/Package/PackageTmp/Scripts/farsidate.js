...
function ToPersianDateDigit(gd) {
    //alert(gd.getFullYear());
    var re = /-?\d+/;
    var m = re.exec(gd);
    var d = new Date(parseInt(m[0]));
...
function ToPersianDateDigitYearRight(gd) {
    //alert(gd.getFullYear());
    var re = /-?\d+/;
    var m = re.exec(gd);
    var d = new Date(parseInt(m[0]));
...
function ToShortPersianDate(gdStr) {
